  ...
  return (
    ...
    >
      <div className={classNames(styles.header)}>
        <h2 className={classNames(styles.title)}>{route.name}</h2>
      ...
      <div className={classNames(styles.content)}>
        <TimeCard
          time={route.today}
          hour={route.update}
          averageTime={route.time}
        />
        <TrafficStatus state={route.state} />
        <RouteStats
          time={Math.round(route.time)}
      ...
      <div className={classNames(styles.footer)}>
        <button onClick={onClose} className={classNames(styles.button)}>
          Cerrar
        </button>
      </div>
    </motion.div>
